...
test('creates a complex HTML document with all major elements', function () {
    $output = ElementFactory::withScope(function () {
        return html(lang: 'en')(
            head()(
                ...
                meta(name: 'description', content: 'A test page for VibeHtml'),
                title(text: 'VibeHtml Test Page'),
            ...
            body(id: 'main-body', class: 'container')(
                ...
                div(id: 'header', class: 'header-section')(
                    h(1, id: 'main-title', class: 'title', text: 'Welcome to VibeHtml'),
                ...
                div(id: 'content', class: 'main-content')(
                    div(class: 'intro')(
                        ...
                        p(text: 'VibeHtml makes building HTML documents easy and type-safe.'),
                        p()(
                    ...
                    form(id: 'contact-form', class: 'contact-form', action: '/submit-contact')(
                        ...
                        div(class: 'form-group')(
                            ...
                            select(id: 'subject', name: 'subject', class: 'form-control')(
                                new \VibeHtml\Elements\Option('general', 'General Inquiry'),
                                new \VibeHtml\Elements\Option('support', 'Technical Support'),
                                new \VibeHtml\Elements\Option('feedback', 'Feedback')
                            )
                        ),
                        div(class: 'form-group')(
                ...
                div(id: 'footer', class: 'footer')(
                    p(text: '© 2026 VibeHtml. All rights reserved.'),
    ...
    expect($output)->toContain('<meta name="description" content="A test page for VibeHtml">');
    expect($output)->toContain('<title>VibeHtml Test Page</title>');
    ...
    expect($output)->toContain('<h1 id="main-title" class="title">Welcome to VibeHtml</h1>');
    ...
    expect($output)->toContain('© 2026 VibeHtml. All rights reserved.');
